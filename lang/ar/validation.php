...
return [
    ...
    'attributes' => [
       'company_owner' => 'اسم مالك الشركة',
       'identify_company' => 'الغرض من الشركة',
       'determine_capital' => 'تحديد راس المال',
       'company_name' => 'اسم الشركة',
       'address' => 'العنوان',
       'bank_name' => 'دفعت بكاملها في بنك',
       'phone' => 'الهاتف',
       'partner_name' => 'اسم الشريك',
       'nationality' => 'الجنسية',
       'occupation' => 'المهنة',
       'address_partner' => 'العنوان',
       'share_partner' => 'الحصه',
       'value_partner' => 'القيمة',
       'ratio_partner' => 'النسبة',
       'id_partner' => 'رقم البطاقة الشخصية أو جواز سفر',
       'place_partner' => 'محل إصدار',
       'date_partner' => 'تاريخ إصدار',
       'company_lease' => 'عقد إيجار الشركة',
       'capital_deposit' => 'شهادة بنكية بإيداع راس المال',
       'establishment_contract' => 'عقد تأسيس',
       'origin_lease' => 'أصل التفويض',
       'image_owner' => 'صورة 4 * 6 لمالك الشركة ',
       'constituent_assembly' => 'محضر اجتماع جمعية تأسيسية ',
       'preliminary_approval' => 'موافقة مبدئية',
       'notes' => 'وصف الملف',
       'current_password' => 'كلمة السر الحالية',
       'password' => 'كلمة السر',
       'address_owner' => 'عنوان مالك الشركة',
       'phone_owner' => 'رقم الهاتف (مالك الشركة)',
       'name_agent' => 'اسم الوكيل',
       'address_agent' => ' عنوان الوكيل',
       'phone_agent' => 'رقم الهاتف (الوكيل)',
       'brand' => 'العلامة التجارية',
       'category' => 'الفئة',
       'description_brand' => 'وصف العلامة التجارية',
       'result' => 'النتيجة',
       'reason' => 'السبب',
       '' => '',
    ]
